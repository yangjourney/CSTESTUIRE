...
from Sub_Model.SubLoginPage import SubLoginPage
...
class Tests(unittest.TestCase):
    def setUp(self):
        ...
        self.baseUrl = "http://10.2.5.139:9000/#/"
    ...
    def test_login(self):
        ...
        :return:
        """
        loginPage = SubLoginPage(self.autoDriver, self.baseUrl)

        # 利用页面对象进行登录
        loginPage.login("test01", "123456",excel_path)
