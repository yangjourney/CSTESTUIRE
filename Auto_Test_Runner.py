...
import time,os,unittest,smtplib,datetime
from email.mime.text import MIMEText
from email.mime.multipart import MIMEMultipart
from email.header import Header

#指定用例及报告的具体路径
test_dir='D:\\CSTESTUIRE\\Test_Case'
test_report_dir='D:\\CSTESTUIRE\\Report'
...
def createSuite():  
    ...
    discover=unittest.defaultTestLoader.discover(test_dir,pattern='slaughter_*.py', top_level_dir=None)
